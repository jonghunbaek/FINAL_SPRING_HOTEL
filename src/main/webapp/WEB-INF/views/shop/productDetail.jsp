...
<!-- PRODUCT IMAGE THUMBNAIL -->
		<div class="col" style="float:left; width:560px; height:680px; border:1px solid gray;">
			<div class="image-input" style="border:1px solid pink; margin: 0 0 34px; height:75%;">
				<img id="thumb-img" src="../resources/images/shop/product/img_product_021.jpg" style="width:100%; height:100%; object-fit: cover;">
			</div>
			<div class="thumb-list" style="border:1px dotted blue; height:15%; text-align: center;">
				<span style="display: inline-block; overflow: hidden;opacity: 1;border:1px solid transparent; width: 80px;height: 80px;"><img src="../resources/images/shop/product/img_product_024.jpg" onmouseenter="changeImage(this);" style="width:100%; height:100%;"></span>
				<span style="display: inline-block; overflow: hidden;opacity: 0.5; border:1px solid #333; width: 80px;height: 80px;"><img src="../resources/images/shop/product/img_product_022.jpg" onmouseenter="changeImage(this);" style="width:100%; height:100%;"></span>
				<span style="display: inline-block; overflow: hidden;opacity: 0.5;border:1px solid transparent; width: 80px;height: 80px;"><img src="../resources/images/shop/product/img_product_023.jpg" onmouseenter="changeImage(this);" style="width:100%; height:100%;"></span>
			</div>
		</div>
...
<!-- PRODUCT SUMMARY -->
	...
	<!-- PRODUCT OPTION CHOICE -->
			...
			<!-- PICKUP DATE -->
			<div class="row" id="opt2DayNTimeDiv" style="background-color:yellow; border:1px solid pink; padding-top: 27px; display:none;">
			...
			<!-- PICKUP LOCATION -->
			<div class="row" id="opt2locationDiv" style="background-color:yellow; border:1px solid pink; padding-top: 27px; display:none;">
				<div class="col-3" style="display: table;">
...
<div class="container" style="background-color:lightgreen; clear:both; padding-top:150px;">
	<div class="row" style="border-top: 1px solid #DCDCDC; padding: 25px 50px;">
		<div class="col-3" style="border:1px solid yellow; font-size: 18px;text-align:center;display:table-cell;vertical-align:top;font-weight: 500;">
			<h5>상품안내</h5>
		</div>
	...
	<div class="row" style="border-top: 1px solid #DCDCDC; padding: 25px 50px;">
		...
		<div class="col-8" style="padding-left:25px;border:1px solid yellow; vertical-align:top;color: #666;">
