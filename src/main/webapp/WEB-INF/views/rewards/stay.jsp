	...
	<div id="div-sidebar">
		...
		<ul class="menu">
			...
			<li id="list"><span>회원전용 프로모션</span>
				<ul id="list-border">
					<li><a href="/rewards/seoul">객실 패키지</a></li>
	...
	<div id="div-contents">
		<div id="div-content3">
			...
			<div>
				<div id="div-box">
					...
					<div class="mb-2" id="keywords">
						<span class="me-3 pt-1" id="span-color" style="float: left;">포함 내용</span>
						<ul>
			...
			<div class="justify-content-center" id="div-tab">
			 	<ul> 
                   	<li id="tabSeoul"><a href="/rewards/seoul" >서울스프링호텔</a></li>
                   	<li id="tabJeju" style="border-left: 0;"><a href="/rewards/jeju" >제주스프링호텔</a></li>
                   	<li id="tabMg" style="border-left: 0;"><a href="/rewards/monogram" >스프링모노그램</a></li>
                   	<li id="tabStay" style="border-bottom: 0; border-left: 0;"><a href="#" >스프링스테이</a></li>
              	</ul>
			</div>
			<div id="div-selector">
				<select>
			...
			<div class="row" id="div-packages">
				<div class="col">
					<div class="packThum">
						<a href="#" onclick="javascript:selectViewPack('17705','S','N');" >
					...
					<div id="div-packCon">
						...
						<dl>
							<dt>
								<a href="#" onclick="javascript:selectViewPack('17705','S','N');">Member Exclusive</a>
							</dt>
							<dd id="dd-border">
