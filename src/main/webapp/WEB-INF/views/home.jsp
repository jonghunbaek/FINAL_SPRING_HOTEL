...
<style>
	...
	#div-specialOffer {display: block; margin: auto; margin-top: 100px; width: 1200px; height: 1200px;}
	#specialOffer img {width: 267px; height: 100px;}
	#plus {float: right; text-align: right; margin-bottom: 20px}
	#plus img {width: 63px; height: 15px;}
	#specialOfferDetail {width: 1200px; height: auto;}
	#specialOfferDetail1 ul {float: left;}
	#specialOfferDetail1 li {display: block;}
	#specialOfferDetail1 img, #specialOfferDetail2 img {}
	...
	#div-rewards h2 {margin-bottom: 30px;}
	#div-rewards ul {float: left;}
	#div-rewards li {display: inline-block; margin: 30px;}
	...
	<div>
		...
		<div class="row" id="div-specialOffer">
			...
			<div class="row" id="specialOfferDetail">
				<div class="col-md-8" id="specialOfferDetail1">
					<div>
						<a href=""><img src="resources/images/home/special_detail_1.jpeg"></a>
					</div>
					<ul>
						<li><a href=""><img src="resources/images/home/special_detail_3.jpeg"></a></li>
						<li><a href=""><img src="resources/images/home/special_detail_4.jpeg"></a></li>
					</ul>
				</div>
				<div class="col-md-4" id="specialOfferDetail2">
					<ul>
						<li><a href=""><img src="resources/images/home/special_detail_2.jpeg"></a></li>
						<li><a href=""><img src="resources/images/home/special_detail_5.jpeg"></a></li>
					</ul>
				</div>
			</div>
		</div>
