...
<body>
	...
	<div class="container-fluid" id="container">
		<div id="div-sidebar">
			<h3 class="fs-7 border-dark border-bottom border-5 pb-3">
				<strong>고객 문의</strong>
			</h3>
		...
		<div class="contacts">
			...
			<div id="detail">
				<div class="location rgt">
					<font class="list"> <span class="crPosit"></span> &gt; 고객문의
						> <strong>문의내역</strong>
					</font>
				</div>
				<div class="headTit">
				...
				<div class="inquiryDetail">
					...
					<c:if test="${inquiry.answerState eq 'Y'}">
						...
						<table class="table">
							...
							<tr>
								<td>답변일</td>
								<td><fmt:formatDate value="${inquiry.answerCreatedDate}"
										pattern="yyyy-M-d" /></td>
							</tr>
							<tr>
								<td>내용</td>
					...
					<c:if test="${inquiry.answerState eq 'N' }">
						<button type="button"
							onclick="location.href='/inquiry/modify?no=${inquiry.no}'">수정</button>
						<button type="button" data-bs-toggle="modal"
							data-bs-target="#deleteCheck">삭제</button>
					</c:if>
					<button style="float: right" type="button"
						onclick="location.href='/inquiry/list'">목록</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn text-white"
						style="background-color: #856F5D;"
						onclick="location.href='/inquiry/delete?no=${inquiry.no}'">확인</button>
					<button type="button" class="btn text-white"
						style="background-color: #856F5D;" data-bs-dismiss="modal">취소</button>
				</div>
			</div>
		</div>
	</div>
